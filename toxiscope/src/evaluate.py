...
Usage:
    python evaluate.py --model outputs/models/deberta_base/best
    python evaluate.py --model outputs/models/deberta_base/best --figures
    python evaluate.py --compare baseline deberta bilstm
"""
